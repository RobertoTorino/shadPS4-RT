# Guidebook: Merging shadPS4 with the Qt GUI

## Phase 1: The Git Merge
...
Make sure the LunarG Vulkan SDK [Vulkan SDK](https://vulkan.lunarg.com/sdk/home) is installed on your Windows machine (with Validation Layers checked). If you just installed it, completely restart VS Code.
...
**If you double-click the newly built .exe, it will crash immediately complaining about missing Qt DLLs.**          
**You must run Qt's deployment tool to copy the necessary libraries into your build folder.**
...
* WrapVulkanHeaders not found? Restart VS Code after installing the Vulkan SDK.
* PathToQString or GetFoolproofInputConfigFile not found? Run git checkout gui-fork/main -- src/common/ to fix this.
